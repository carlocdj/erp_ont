...
- **Vercel** — drag & drop del progetto source o della cartella `dist/` (include `vercel.json` per SPA routing)
- **Cloudflare Pages** — connetti repo GitHub o drag & drop
...
**Fix Vercel 404:** Il file `vercel.json` gestisce il routing SPA — tutte le rotte vengono reindirizzate a `/` dove React Router prende il controllo.
